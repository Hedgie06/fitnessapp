...
import 'package:fitnessapp/view/workour_detail_view/widgets/Fullstep_detail_row.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:readmore/readmore.dart';

class FullBodyWorkoutDetailStep extends StatefulWidget {
  final Map eObj;
  const FullBodyWorkoutDetailStep({Key? key, required this.eObj}) : super(key: key);

  @override
  State<FullBodyWorkoutDetailStep> createState() => _FullBodyWorkoutDetailStepState();
}

class _FullBodyWorkoutDetailStepState extends State<FullBodyWorkoutDetailStep> {
  List stepArr = [
    {
      "no": "01",
